...
public class ScheduleSwapMove implements Move {
    ...
    public boolean isMoveDoable(ScoreDirector scoreDirector) {
        return !(leftSchedule.getClassroom().equals(rightSchedule.getClassroom())
                && leftSchedule.getDay().equals(rightSchedule.getDay()));
    }
    ...
    public void doMove(ScoreDirector scoreDirector) {
        ...
        if (oldLeftDay.equals(oldRightDay)) {
        	ScheduleMoveHelper.moveClassroom(scoreDirector, leftSchedule, oldRightClassroom);
        	ScheduleMoveHelper.moveClassroom(scoreDirector, rightSchedule, oldLeftClassroom);
        } else if (oldLeftClassroom.equals(oldRightClassroom)) {
        	ScheduleMoveHelper.moveDay(scoreDirector, leftSchedule, oldRightDay);
        	ScheduleMoveHelper.moveDay(scoreDirector, rightSchedule, oldLeftDay);
        } else {
        	ScheduleMoveHelper.moveSchedule(scoreDirector, leftSchedule, oldRightDay, oldRightClassroom);
        	ScheduleMoveHelper.moveSchedule(scoreDirector, rightSchedule, oldLeftDay, oldLeftClassroom);
        }
    }
    ...
    public Collection<? extends Object> getPlanningValues() {
        return Arrays.<Object>asList(leftSchedule.getDay(), leftSchedule.getClassroom(),
        		rightSchedule.getDay(), rightSchedule.getClassroom());
    }
    ...
    public boolean equals(Object o) {
        if (this == o) {
            ...
            return new EqualsBuilder()
                    .append(leftSchedule, other.leftSchedule)
                    .append(rightSchedule, other.rightSchedule)
                    .isEquals();
        } else {
            return false;
        }
