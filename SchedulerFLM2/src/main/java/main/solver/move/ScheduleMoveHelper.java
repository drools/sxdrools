...
public class ScheduleMoveHelper {
	...
	public static void moveClassroom(ScoreDirector scoreDirector, Schedule schedule, Classroom classroom) {
		scoreDirector.beforeVariableChanged(schedule, "classroom");
		schedule.setClassroom(classroom);
        scoreDirector.afterVariableChanged(schedule, "classroom");
	}
	
	public static void moveDay(ScoreDirector scoreDirector, Schedule schedule, Day day) {
		scoreDirector.beforeVariableChanged(schedule, "day");
		schedule.setDay(day);
        scoreDirector.afterVariableChanged(schedule, "day");
	}
	
	public static void moveSchedule(ScoreDirector scoreDirector, Schedule schedule, Day day, Classroom classroom) {
